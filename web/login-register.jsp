<%-- 
    Document   : login_jsp
    Created on : May 6, 2019, 9:55:48 PM
    Author     : Trung Nguyen
--%>
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12 mb-20">
                                            ...
                                            <input name="address" class="mb-0" type="email" placeholder="Email Address">
                                        </div>
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-20">
                                            ...
                                            <input name="username" class="mb-0" type="text" placeholder="Username" required="Enter your username">
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            <label>Password</label>
                                            <input name="password" class="mb-0" type="password" placeholder="Password" required="Enter your password">
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            <label>Confirm Password</label>
                                            <input name="confirmpassword" class="mb-0" type="password" placeholder="Confirm Password" required="Enter your password">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>Date of birth</label>
                                            <input class="mb-0" type="date" name="date"  min="1890-01-01" max="2001-13-13">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>Street</label>
                                            <input name="street" class="mb-0" type="text" placeholder="Street">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>District</label>
                                            <input name="district" class="mb-0" type="text" placeholder="District">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>City</label>
                                            <input name="city" class="mb-0" type="text" placeholder="City">
                                        </div>
                                        <div class="col-12">
